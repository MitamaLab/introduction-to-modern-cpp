...
さらに、本講義の N 章を読む場合は N - 1 章を読み終えていることを前提としています。
つまり、本講義の3章を読む場合は『独習C++ 新版』の3章までを読み終えていることを前提とし、本講義の1章と2章を読み終えていることが前提です。

C++20で言語機能の大幅な変更があったため、C++17とC++20では大きな違いがあります。C++23では言語機能には大きな変更はなく、ライブラリ機能の追加が大きいと言えるでしょう (ユーザーにとってはそうだが、C++23 で追加された言語機能はライブラリ設計者にとっては革命的である)。
